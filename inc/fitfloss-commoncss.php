...
// enqueue css
function fitfloss_common_custom_css(){
    
    wp_enqueue_style( 'fitfloss-common', get_template_directory_uri().'/assets/css/common.css' );

		$whiteColor     		  	= '#ffffff';
		$themeColor     		  	= fitfloss_opt( 'fitfloss_theme_color' );
		$themeSecColor     		  	= '';
		$bookBtnBgColor       		= fitfloss_opt( 'fitfloss_book_btn_bg_color' ) != '#ff0000' ? fitfloss_opt('fitfloss_book_btn_bg_color') : '';
		$bookBtnHoverBgColor     	= fitfloss_opt( 'fitfloss_book_btn_hvr_color' ) != '#000000' ? fitfloss_opt('fitfloss_book_btn_hvr_color') : '';
		$hoverColor     	  	  = fitfloss_opt( 'fitfloss_quote_btn_hvr_text_color');

		$headerTop_bg     		  = '';
		$navbarBgColor     		  = fitfloss_opt( 'fitfloss_navbar_bg_color' ) != '#082b49' ? fitfloss_opt( 'fitfloss_navbar_bg_color') : '';
		$headerTop_col     		  = fitfloss_opt( 'fitfloss_top_header_color' );

		$headerTopBg      		  = fitfloss_opt( 'fitfloss_top_header_bg_color');
		$headerBg          		  = fitfloss_opt( 'fitfloss_header_bg_color') != '#ff0000' ? fitfloss_opt( 'fitfloss_header_bg_color') : $themeColor;
		$menuColor          	  = fitfloss_opt( 'fitfloss_header_menu_color' ) != '#ffffff' ? fitfloss_opt('fitfloss_header_menu_color') : '';
		$menuHoverColor           = fitfloss_opt( 'fitfloss_header_menu_hover_color' ) != '#ff0000' ? fitfloss_opt('fitfloss_header_menu_hover_color') : $themeColor;
		$menuFixedHoverColor      = fitfloss_opt( 'fitfloss_header_menu_fixed_hover_color' );
		$dropMenuBgColor          = fitfloss_opt( 'fitfloss_header_drop_menu_bg_color' ) != '#ffffff' ? fitfloss_opt('fitfloss_header_drop_menu_bg_color') : $themeColor;
		$dropMenuColor            = fitfloss_opt( 'fitfloss_dropdown_menu_color' ) != '#000000' ? fitfloss_opt('fitfloss_dropdown_menu_color') : '';
		$dropMenuHovColor         = fitfloss_opt( 'fitfloss_dropdown_menu_hover_color' ) != '#ff0000' ? fitfloss_opt('fitfloss_dropdown_menu_hover_color') : $themeColor;

		$footerwbgColor     	  = fitfloss_opt( 'fitfloss_footer_widget_bg_color' ) != '#ff0000' ? fitfloss_opt('fitfloss_footer_widget_bg_color') : $themeColor;
		$footerwHeadColor   	  = fitfloss_opt('fitfloss_footer_widget_heading_color');
		$footerwTextColor   	  = fitfloss_opt('fitfloss_footer_widget_text_color');
		$footerwanchorcolor 	  = fitfloss_opt('fitfloss_footer_widget_anchor_color') != '#ffffff' ? fitfloss_opt('fitfloss_footer_widget_anchor_color') : '';
		$footerwanchorhovcolor    = fitfloss_opt('fitfloss_footer_widget_anchor_hover_color') != '#ffffff' ? fitfloss_opt('fitfloss_footer_widget_anchor_hover_color') : $themeColor;
		
		$fofbg					  = fitfloss_opt('fitfloss_fof_bg_color');
		$foftonecolor			  = fitfloss_opt('fitfloss_fof_textone_color');
		$fofttwocolor			  = fitfloss_opt('fitfloss_fof_texttwo_color');

		$bannerBtnHeaderSpanColor = $themeColor != '#ff5e13' ? $themeColor : '';
		$footerAncDefColor 		  = fitfloss_opt('fitfloss_footer_widget_anchor_color') != '#e5e5e5' ? fitfloss_opt('fitfloss_footer_widget_anchor_color') : $themeSecColor;
		...
		$customcss ="			
			...
			.btn_4, .our_Professional .single_industries_text:hover, .pricing_part .single_pricing_part .pricing_content .btn_2:hover, .comment-form .comment-respond .btn_2:hover, .popular_cource .single_popular_cource .btn_2:hover, .gallery_part .btn_2:hover{
				border-color: {$themeColor};
				background-color: {$themeColor};
			}
			.btn_4:hover, .about-area .section-title .boxed-btn:hover {
				color: {$themeColor}!important;
			}
			...
			.main_menu ul li a:hover:before, .main_menu ul.navbar-nav li a::before, .header-area .main-header-area .main-menu ul li a::before, .header-area .main-header-area.sticky .main-menu ul li a::before {
			...
			.footer-area .single-footer-widget h4, .footer-area .single-footer-widget .office-location ul li strong, .footer .footer_top .footer_widget .footer_title, .footer_area .subscribe_part_text h2, .footer_area .single-footer-widget h4, .footer_area .footer_widget h3
			{
				color: {$footerwHeadColor}
			}
			.footer-area .single-footer-widget p, .footer-area .widget_fitfloss_newsletter .input-group input, .footer-area .copyright_part_text p, .footer_Part .copyright_part p, .footer-area .footer_2 .social_icon a, .footer_Part .footer_text h2, .footer-area .single-footer-widget .office-location ul li p, .footer .footer_top .footer_widget p, .footer .footer_top .footer_widget .newsletter_text, .footer .copy-right_text .copy_right, .footer_area .copyright_text p, .footer_area .footer_widget .offer_text, .footer_area .footer-bottom .copyright .footer-text, .footer-area .single-footer-widget h2
			{
			...
			.footer-area .copyright_part_text .footer-text > a, .footer_Part .copyright_part p > a, .footer .copy-right_text .copy_right a, .footer_area .copyright_text p a, .footer_area .footer-bottom .copyright .footer-text a
			{
			...
			.footer-area .single-footer-widget .btn, .footer .footer_top .footer_widget .fitfloss_mailchimp_newsletter_widget button, .footer .footer_top .footer_widget .fitfloss_mailchimp_newsletter_widget button
			{
			...
			.header-area .main-header-area .boxed_btn_white, .main_menu nav .btn_1
			{
				background: {$bookBtnBgColor};
			}
			.header-area .main-header-area .boxed_btn_white:hover, .main_menu nav .btn_1:hover
			{
    ...
    wp_add_inline_style( 'fitfloss-common', $customcss );
    
}
add_action( 'wp_enqueue_scripts', 'fitfloss_common_custom_css', 50 );