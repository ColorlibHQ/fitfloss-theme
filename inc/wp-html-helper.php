...
// image default alt
if ( ! function_exists( 'fitfloss_img_default_alt' ) ) {
	function fitfloss_img_default_alt( $url = '' ) {
...
// Image Tag
if ( ! function_exists( 'fitfloss_img_tag' ) ) {
	function fitfloss_img_tag( array $args ) {
		...
		if ( ! empty( $args['alt'] ) ) {
			...
			$alt = fitfloss_img_default_alt( $url );
		}
...
// Anchor Tag
if ( ! function_exists( 'fitfloss_anchor_tag' ) ) {
	function fitfloss_anchor_tag( array $args ) {
...
// Heading Tag
if ( ! function_exists( 'fitfloss_heading_tag' ) ) {
	function fitfloss_heading_tag( array $args ) {
...
// Paragraph Tag
if ( ! function_exists( 'fitfloss_paragraph_tag' ) ) {
	function fitfloss_paragraph_tag( array $args ) {
...
// Other Tag
if ( ! function_exists( 'fitfloss_other_tag' ) ) {
	function fitfloss_other_tag( array $args ) {
...
// Button Element 
if ( ! function_exists( 'fitfloss_button_element ' ) ) {
	function fitfloss_button_element( array $args ) {
